...
namespace SweetHome.Utils
{
    ...
    public static class Json
    {
        ...
        public static string SerializeObject<T>(object obj, Expression<Func<T, object>> selector1, Expression<Func<T, object>> selector2)
        {
            return SerializeObject(obj, new IgnorableSerializerContractResolver().Ignore<T>(selector1).Ignore<T>(selector2));
        }
        public static string SerializeObject<T>(object obj, Expression<Func<T, object>> selector1, Expression<Func<T, object>> selector2, Expression<Func<T, object>> selector3)
        {
            return SerializeObject(obj, new IgnorableSerializerContractResolver().Ignore<T>(selector1).Ignore<T>(selector2).Ignore<T>(selector3));
        }
    }
}
